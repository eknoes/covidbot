    ...
    def _get_report(self, subscriptions: List[int]) -> str:
        ...
        if country.icu_data:
            message += f"<b>🏥 Intensivbetten</b>\n" \
                       ...
                       f" mit COVID-19, davon müssen {format_noun(current_data.icu_data.covid_ventilated, FormattableNoun.BEDS)} beatmet mit COVID-19, davon müssen {format_noun(country.icu_data.covid_ventilated, FormattableNoun.BEDS)} beatmet werden. " \
