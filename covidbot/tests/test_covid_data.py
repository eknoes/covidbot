...
class CovidDataTest(TestCase):
    ...
    def test_unicode(self):
        self.assertIsNotNone(
            self.data.search_district_by_name("den neuen Bericht finde ich super! 👍🏽"))

    def test_find_ags(self):
        self.assertEqual(2, len(self.data.search_district_by_name("Kassel")),
                         "2 Entities should be found for Kassel")
        self.assertEqual(1, len(self.data.search_district_by_name("Essen")),
                         "Exact match should be chosen")
        self.assertEqual(1, len(self.data.search_district_by_name("Berlin")),
                         "Exact match should be chosen")
        ...
        self.assertEqual(1, len(self.data.search_district_by_name("Kassel Land")),
                         "Kassel Land should match LK Kassel")
        self.assertEqual(1, len(self.data.search_district_by_name("Bundesland Hessen")),
                         "Exact match should be chosen")

    def test_find_abbr(self):
        self.assertEqual(1, len(self.data.search_district_by_name("SH")))
        self.assertEqual(1, len(self.data.search_district_by_name("NRW")),
                         "NRW should match")
    ...
    def test_get_district_data(self):
        ...
        self.assertIsNone(non_existent,
                          "get_district_data should return None for non-existing data")

    def test_get_root_district_data(self):
        self.data.get_district_data(0)
